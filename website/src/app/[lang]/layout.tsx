...
const fontClassMap: Record<Locale, string> = {
  he: heebo.className,
  en: inter.className,
  ar: notoArabic.className,
};

const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || "https://gate-jerusalem.co.il";
...
const metadataMap: Record<Locale, Metadata> = {
  he: {
    ...
    alternates: { canonical: `${SITE_URL}/he` },
    openGraph: {
...
export default async function LangLayout({
  ...
  return (
    <html
      ...
      className={`${heebo.variable} ${inter.variable} ${notoArabic.variable} antialiased`}
    >
      <body className={`min-h-full flex flex-col ${fontClassMap[locale]}`}>
        {children}
      </body>
    </html>
  );
