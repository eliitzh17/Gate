      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        {activeTab === "layout" && (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
            <div className="bg-gray-light rounded-2xl p-4 md:p-8">
              <div className="max-w-4xl mx-auto rounded-xl overflow-hidden shadow-inner bg-white"><Image src="/images/floor24-layout.png" alt={t.layoutTitle} width={3573} height={2526} className="w-full h-auto" quality={90} /></div>
        ...
        {activeTab === "models" && (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
            ...
            <div className="bg-gray-light rounded-2xl p-4 md:p-8">
              <div className="max-w-4xl mx-auto rounded-xl overflow-hidden shadow-inner bg-white"><Image key={activeModelGroup} src={activeModelGroup === "ABCH" ? "/images/floor24-models-ABCH.png" : "/images/floor24-models-DEFG.png"} alt={`${t.model} ${activeModelGroup}`} width={5803} height={3351} className="w-full h-auto" quality={90} /></div>
