...
export default function Location() {
  ...
  const destinations = [
    { time: "32", name: t.train, hook: t.trainHook, mode: t.byTrain, images: ["/images/locations/tel-aviv-1.jpg", "/images/locations/tel-aviv-2.jpg", "/images/locations/tel-aviv-3.jpg"] },
    { time: "5", name: t.lightRail, hook: t.lightRailHook, mode: t.byFoot, images: ["/images/locations/light-rail-1.jpg", "/images/locations/light-rail-2.jpg", "/images/locations/light-rail-3.jpg"] },
    { time: "10", name: t.knesset, hook: t.knessetHook, mode: t.byFoot, images: ["/images/locations/knesset-1.jpg", "/images/locations/knesset-2.jpg", "/images/locations/knesset-3.jpg"] },
    { time: "10", name: t.sacherPark, hook: t.sacherParkHook, mode: t.byFoot, images: ["/images/locations/sacher-park-1.jpg", "/images/locations/sacher-park-2.jpg", "/images/locations/sacher-park-3.jpg"] },
    { time: "15", name: t.machaneYehuda, hook: t.machaneYehudaHook, mode: t.byFoot, images: ["/images/locations/machane-yehuda-1.jpg", "/images/locations/machane-yehuda-2.jpg", "/images/locations/machane-yehuda-3.jpg"] },
    { time: "15", name: t.oldCity, hook: t.oldCityHook, mode: t.byRail, images: ["/images/locations/old-city-1.jpg", "/images/locations/old-city-2.jpg", "/images/locations/old-city-3.jpg"] },
  ];
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {destinations.map((d, i) => (
            ...
            >
              <RotatingImage images={d.images} alt={d.name} interval={2000 + i * 300} />
