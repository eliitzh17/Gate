...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-navy">
      <Image src="/images/Gate_v1_hi-res_0821.jpg" alt={dict.alt.heroMain} fill sizes="100vw" className="object-cover z-0" priority quality={85} />
        ...
        <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.6 }} className="mt-2 mb-12 max-w-2xl mx-auto">
          <div className="relative rounded-xl overflow-hidden shadow-2xl aspect-video cursor-pointer group" onClick={() => !videoActive && setVideoActive(true)}>
            {videoActive ? (
              ...
              <>
                <Image src="/images/Gate_v5_hi-res_0904-副本-1.jpg" alt={dict.alt.heroVideo} fill sizes="(max-width: 672px) 100vw, 672px" className="object-cover" />
